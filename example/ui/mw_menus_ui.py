...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuMenu = QtWidgets.QMenu("Menu", window)
        self.menuMenu.setObjectName("menuMenu")
        self.menuMenuSub = QtWidgets.QMenu(self.menuMenu)
        self.menuMenuSub.setObjectName("menuMenuSub")
        self.menuMenuDelayed = QtWidgets.QMenu("Menu Delayed", window)
        ...
        self.menuMenuCheckale = QtWidgets.QMenu("Menu Checkable", window)
        self.menuMenuCheckale.setObjectName("menuMenuCheckale")
        self.menuNew = QtWidgets.QMenu(self.menuMenuCheckale)
        self.menuNew.setObjectName("menuNew")
        self.menuAbout = QtWidgets.QMenu("About QRainbowStyle", window)
        self.menuAbout.setObjectName("menuAbout")
        self.menuHelp = QtWidgets.QMenu("Help", window)
        self.menuHelp.setObjectName("menuHelp")

        window.addMenu(self.menuMenu)
        window.addMenu(self.menuMenuDelayed)
        window.addMenu(self.menuMenuCheckale)
        # window.addMenu(self.menuAbout)
        # window.addMenu(self.menuHelp)
